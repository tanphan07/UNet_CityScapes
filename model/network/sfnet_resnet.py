...
import torch
from nn.operators import AlignedModule, PSPModule
...
class AlignNetResNet(nn.Module):
    def __init__(self, num_classes, trunk='resnet-101', variant='D',
...
def DeepR101_SF_deeply(num_classes):
    ...
    """
    return AlignNetResNet(num_classes, trunk='resnet-101-deep', variant='D', skip='m1')
...
def DeepR50_SF_deeply(num_classes):
    ...
    ResNet-50 Based Network
    """
    return AlignNetResNet(num_classes, trunk='resnet-50-deep', variant='D', skip='m1')


def DeepR18_SF_deeply(num_classes):
    """
    ResNet-18 Based Network
    """
    return AlignNetResNet(num_classes, trunk='resnet-18-deep', variant='D', skip='m1')


def DeepR18_SF_deeply_dsn(num_classes):
    """
